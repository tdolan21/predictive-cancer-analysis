...
def add_prediction(input_data):
    ...
    st.write("This app is not a substitute for a medical professional. Please consult your doctor for a diagnosis.")
...
def main():
    ...
    with st.container():
        ...
        st.write("Please connect this app to your cytology lab to help diagnose breast cancer. This app predicts using a machine learning model whether a tumor is benign or malignant based on the measuremnents it receives from your cytosis lab. The measurements can be adjusted in the sidebar.")
